...
//
//            val user = userService.getAllUser().find { it.username == username }
//
//            if (user != null) {
//                if (user.familyId == null) {
//                    familyService.getAllFamilies().add(mapToFamily())
//
//                    userService.getAllUser().find { it == user }?.familyId = familyStorage.last().id
